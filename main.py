...
btn_sub = Button(root,text='-',bg='#ff9500',fg='white',width=5,height=2,command=lambda :get_operator('-'))
...
btn_mul = Button(root,text='*',bg='#ff9500',fg='white',width=5,height=2,command=lambda :get_operator('*'))
